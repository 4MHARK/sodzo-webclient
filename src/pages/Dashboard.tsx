          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-xl font-bold text-gray-900 dark:text-white">127</span>
              </motion.div>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">Hours Logged</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">This week</p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">Pending Reviews</p>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">New comment on Customer Portal</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">Task completed in Analytics Dashboard</p>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-gray-900 dark:text-white">New file uploaded to Cloud Storage</p>
