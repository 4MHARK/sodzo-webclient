  ...
  return (
    ...
    >
      ...
      >
          ...
          {mockProjects.map((project, index) => (
            <motion.button
              ...
              className={`w-full p-4 text-left hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 transition-colors ${
                selectedProject.id === project.id ? 'bg-blue-50 dark:bg-blue-900/20 border-r-2 border-blue-500' : ''
              }`}
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{project.team.length} members</p>
                </div>
              </div>
            </motion.button>
          ))}
        ...
        >
          <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Online Team Members</h3>
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{selectedProject.name}</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">{selectedProject.team.length} members</p>
              </div>
            </div>
            <motion.button 
              className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
               ...
               <>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center space-x-2">
                    <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100">{message.userName}</h3>
          ...
          <form onSubmit={handleSendMessage} className="flex space-x-3">
            <div className="flex-1">
              <motion.input
                ...
                placeholder={`Message #${selectedProject.name.toLowerCase().replace(/\s+/g, '-')}`}
