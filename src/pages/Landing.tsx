...
import AuthModal from "../components/AuthModal"; // <-- import here
    ...
    <div className="min-h-screen w-full flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full min-h-screen max-w-7xl mx-auto px-4 md:px-12 py-8 md:py-12">
        ...
        <section className="h-full flex flex-col items-center justify-center text-center py-8">
          ...
          >
            Sodzo helps organizations and academic bodies collect, track, and manage
            critical submissions — from project files to administrative forms — all in
            one secure place.
          </motion.p>
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-10">
            ...
            >
              Start Submitting <span className="text-xl">→</span>
            </button>
            <button
              onClick={() => {
                setAuthTab("login");
