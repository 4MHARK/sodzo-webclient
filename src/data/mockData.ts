...
export const mockUser: User[] = [
  {
    ...
    avatar: "https://halocrm.s3.us-east-1.amazonaws.com/user/avatar-06.webp",
    roles: [],
    isOwner: true,
    isSuper: false,
    isAgreed: true,
    phoneNumber: "+3329979570351",
    isPhoneVerified: false,
    isEmailVerified: false,
    tenantId: "bce76jne6F",
    createdAt: "2025-04-10T05:33:17.330Z",
    haloId: "HL-0003H",
    status: false,
  },
  {
    id: "680ab0be19685413ab6e5c30",
    firstname: "Sarah",
    lastname: "Johnson",
    ...
    isSuper: false,
    isAgreed: true,
    phoneNumber: "+3329979570352",
    isPhoneVerified: true,
    isEmailVerified: true,
    tenantId: "bce76jne6F",
    createdAt: "2025-04-11T05:33:17.330Z",
    haloId: "HL-0004H",
    status: true,
  },
  {
    id: "680ab0be19685413ab6e5c31",
    firstname: "Michael",
    lastname: "Chen",
    ...
    isSuper: false,
    isAgreed: true,
    phoneNumber: "+3329979570353",
    isPhoneVerified: true,
    isEmailVerified: false,
    tenantId: "bce76jne6F",
    createdAt: "2025-04-12T05:33:17.330Z",
    haloId: "HL-0005H",
    status: true,
  },
  {
    id: "680ab0be19685413ab6e5c32",
    firstname: "Emily",
    lastname: "Rodriguez",
    ...
    isSuper: false,
    isAgreed: true,
    phoneNumber: "+3329979570354",
    isPhoneVerified: false,
    isEmailVerified: true,
    tenantId: "bce76jne6F",
    createdAt: "2025-04-13T05:33:17.330Z",
    haloId: "HL-0006H",
    status: false,
  },
  {
    id: "680ab0be19685413ab6e5c33",
    firstname: "David",
    lastname: "Kim",
    ...
    isSuper: false,
    isAgreed: true,
    phoneNumber: "+3329979570355",
    isPhoneVerified: true,
    isEmailVerified: true,
    tenantId: "bce76jne6F",
    createdAt: "2025-04-14T05:33:17.330Z",
    haloId: "HL-0007H",
    status: true,
  },
  {
    id: "680ab0be19685413ab6e5c34",
    firstname: "Olivia",
    lastname: "Brown",
...
export const mockProjects: Project[] = [
  {
    ...
    status: 'active',
    progress: 75,
    team: [mockUser[0], mockUser[1], mockUser[2]],
